#@# 最後の原稿生成時のコミット: 3e955ca283165eaf802a22dc5a4f01adc63fa3f3
...
まず初めに、ドリルダウンしたいデータを、チャート上でクリックする。ここでは、2025/8の売り上げデータの内訳をドリルダウンしようとしている。

//image[chapter01/drilldown-1-choice_bar][ドリルダウンするデータの選択]{
//}

次に、どの列単位で内訳を見たいかを選択する。ここでは、商品のカテゴリごとに内訳を確認することにする。

//image[chapter01/drilldown-2-choise_column][分析列の選択]{
//}

最後に出てきた結果を見やすいチャートに変換する。ドリルダウンして新しく表示されたチャートでは、あらかじめfilterで選択したデータだけが抽出されるようになっている。ここでは棒グラフを円グラフに変換して、内訳をみやすくしている。
